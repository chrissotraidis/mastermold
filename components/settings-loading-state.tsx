...
const settingsLoadingContext: ChatPageContext = {
  ...
  route: "/settings",
  summary:
    "The Settings page is loading. The user may want portfolio data setup, profile setup, portfolio connections, AI/chat keys, Web3 wallet setup, safety limits, or a setup check.",
};
...
const setupSections = [
  {
    ...
    detail: "Current holdings source and snapshot freshness",
  },
  {
    title: "Profile",
    ...
    >
      <div className="hidden min-w-0 rounded-md border border-violet/30 bg-violet/[0.045] p-4 sm:block sm:p-5">
        ...
        <p className="mt-2 max-w-2xl text-sm leading-6 text-on-surface-variant">
          Portfolio data, profile, connections, AI keys, Web3 setup, and safety limits are loading. No account import, live chat test, or trade can run unless you choose it.
        </p>
        <CommandConsole
          className="mt-4"
