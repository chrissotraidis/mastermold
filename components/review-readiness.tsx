...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "The launch checklist now includes a top-cockpit dry-run signer setup action that scopes a public-key rehearsal, signer simulation metadata, caps, slippage, and kill-switch review while still refusing private keys, transaction submission, custody, wallet mutation, or real-capital trading.",
