...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "Settings and /api/web3-operator-request-packet now expose a shareable redacted Web3 request packet with the next ordered unlock step, full operator unlock sequence, required inputs, safe-to-provide values, never-provide values, verifier commands, and blocked live-authority boundaries.",
