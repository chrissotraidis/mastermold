...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "A Web3 credential doctor command can now read local account setup, provider health, launch checklist, and live preflight receipts, write a sanitized local doctor receipt, and surface it in Settings without echoing secrets or changing wallet authority.",
      "Settings now also includes a session-only Web3 credential action console that can test Helius/Solana, read-only DEX scanner evidence, wallet scope, and Jupiter rehearsal routes without saving API keys, accepting private keys, returning transaction bytes, or unlocking live execution.",
