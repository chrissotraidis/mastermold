...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "The Web3 credential setup now also displays a provider account runway for the researched stack: Helius/Solana reads, Jupiter rehearsal, dedicated trading wallet, manual external signer, discovery feeds, low-latency stream, emergency stop, and tax/accounting ledger, while making clear that the app does not create third-party accounts, store signer secrets, or unlock live execution.",
