...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "A Web3 credential doctor command can now read local account setup, provider health, launch checklist, live preflight, and production-supervisor receipts, optionally refresh one bounded paper-supervisor round, write a sanitized local doctor receipt, and surface it in Settings without echoing secrets or changing wallet authority.",
