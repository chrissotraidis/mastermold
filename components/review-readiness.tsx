...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "The Web3 trading cockpit now shows a first-screen operator input packet driven by the live canary receipt, naming the next safe public/env/proof input, owner, safe surface, verifier command, open canary input rows, and never-paste boundary before the full canary console and long workspace.",
