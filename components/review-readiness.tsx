...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "A Node-only npm run research:web3 command now prints that same redacted Web3 research handoff as Markdown or JSON while checking live execution, transaction submission, wallet mutation, private-key storage, seed-phrase storage, and secret echo all stay blocked.",
