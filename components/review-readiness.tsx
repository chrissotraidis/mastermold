...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "The Settings credential console can now create a text-only wallet ownership proof from a browser Solana wallet message signature, then return only hash evidence while transaction signing, submission, live execution, private-key storage, and wallet mutation remain blocked.",
      ...
      "A Node-only npm run verify:web3 gate now checks the running app's Web3 health receipts, malformed wallet rejection, private-field rejection, public dry-run wallet scope save, validate-only credential redaction, configured Helius/Solana provider-health proof, deterministic DEX discovery receipt boundaries, one-shot Jupiter rehearsal redaction, and live-execution/wallet-mutation locks for machines where Bun tests are unavailable.",
