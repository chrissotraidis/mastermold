...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "/api/web3-live-trade-canary, /api/web3-live-unsigned-order-handoff, /api/web3-wallet-ownership, Trading, and Settings now explicitly state whether a real live trade has actually been tested, separate paper/read-only/Jupiter rehearsal from money movement, let Trading preflight the exact canary wallet before any prompt, let Trading prove wallet ownership with a text-only hash receipt, show a canary launch checklist for preflight, wallet signing, relay, and confirmation/accounting, show the post-signing proof chain for signed relay, chain confirmation, settlement reconciliation, and portfolio mirror accounting, and let the live Trading canary run a bounded auto-watch proof loop after a wallet signature.",
