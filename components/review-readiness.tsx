...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "The quick Web3 controls now include a first-screen next-moves timeline built from the data-freshness gate, command execution, action queue, runway, launch timing, trigger opportunity, loop throttle, and wallet feedback, so read-only refreshes, fresh-entry timing, protective paper sells, and blocked live-submit gates are visible before expert diagnostics.",
      ...
      "The Web3 API and compact cockpit now include a profit-redeploy execution receipt that maps the redeploy autopilot to the ranked-opportunity, re-entry, or protect-first paper candidate, caps it to released-paper budget or held-position value, records queued/applied/blocked status, owns the local paper fill id/lane when queued or applied, and keeps live swaps, signing, custody, and profit guarantees out of scope.",
