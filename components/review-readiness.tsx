...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "/api/web3-live-trade-canary now checks signed-payload request continuity before attempting relay, reports the expected current request id, marks stale or missing canary request ids as blocked, and still never echoes signed payloads, private keys, seed phrases, API keys, raw transaction fields, wallet authority, or live execution permission.",
