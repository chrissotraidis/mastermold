...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "Settings and /api/web3-operator-request-packet now expose a shareable redacted Web3 request packet with the next ordered unlock step, full operator unlock sequence, required inputs, safe-to-provide values, never-provide values, verifier commands, a copy action for the redacted text, and blocked live-authority boundaries.",
      ...
      "That refreshed Settings console receipt now includes the top dependency-ranked live-usability blocker rows, an Open current gate jump, and an Open blocker JSON link, so the exact next public/env/review row is visible after each safe action.",
