...
const disclosureSections = [
  ...
  },
  {
    ...
    items: [
      ...
      "Execution retry planning, preflight, transaction lifecycle tracking, signed-relay attempts, read-only signature confirmation polling, Jupiter Trigger create/history/reconcile drills, portfolio-mirror guard checks, and guarded local portfolio-mirror apply requests record route, fee, quote age, quote timestamp, context slot, nonce, request id, retry-window, blocker metadata, payload hash, byte count, lifecycle stage, signature/status metadata, fill estimates, applied order ids, idempotency evidence, bounded fill notional, fill price, filled quantity, and synthetic signer proof locally. They do not store transaction bodies, sign with real keys, or accept private keys.",
