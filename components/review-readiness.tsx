...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "/api/health now exposes compact Web3 research handoff and live-usability blocker summaries with question counts, missing real-money input counts, live-blocker counts, and the same live-execution, wallet-mutation, signing, private-key, seed-phrase, and secret-echo locks.",
      ...
      "/api/web3-live-usability-blockers now reconciles usability, cutover, runbook, live-capital preflight, supervised runway, and manual live-review receipts into one what-is-left contract while signing, submission, wallet mutation, private-key storage, seed-phrase storage, and secret echo remain blocked.",
