...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "Settings credential console now includes the same no-transaction Canary preflight as Trading, checking the exact public wallet, tiny amount, slippage, live flags, source/account scope, and Jupiter env before any browser-wallet transaction prompt while returning no transaction bytes.",
