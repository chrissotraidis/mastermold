...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "/api/web3-live-trade-canary, Trading, and Settings now explicitly state whether a real live trade has actually been tested, separate paper/read-only/Jupiter rehearsal from money movement, show the post-signing proof chain for signed relay, chain confirmation, settlement reconciliation, and portfolio mirror accounting, and let the live Trading canary run a bounded auto-watch proof loop after a wallet signature.",
