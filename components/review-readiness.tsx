...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "Signer ops compares external wallet prompts, Privy server-wallet, Turnkey policy-wallet, and session-key-vault paths, then exposes the active provider's hash-only signature request envelope, auto-sign, user-presence, payload-hash, expiry, cap, and live-gate readiness without returning raw or signed transaction bytes.",
      ...
      "A read-only Solana wallet holdings adapter can now scan all SPL token accounts with getTokenAccountsByOwner when SOLANA_RPC_URL and a public wallet key are scoped, price wallet-held mints against the live DEX tape, disclose unpriced accounts, and feed priced balances into local protection and dry-run route rehearsal without signatures, private keys, approvals, transfers, custody, or wallet mutation.",
