...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "The Web3 API and compact cockpit now include a profit-redeploy execution receipt that maps the redeploy autopilot to the ranked-opportunity or re-entry paper candidate, caps it to released-paper budget, records queued/applied/blocked status, and keeps live swaps, signing, custody, and profit guarantees out of scope.",
