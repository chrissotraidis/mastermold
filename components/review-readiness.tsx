...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "/api/web3-live-trade-canary and Settings now explicitly state whether a real live trade has actually been tested, separate paper/read-only/Jupiter rehearsal from money movement, and list the missing browser-wallet signer, external signed-payload, live env, request-id, accounting, and review blockers before anyone can claim real funds moved.",
