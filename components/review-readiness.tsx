...
const disclosureSections = [
  ...
  },
  {
    ...
    items: [
      ...
      "Signer ops results are provider readiness metadata. They can say whether a wallet prompt, Privy-style server wallet, Turnkey-style policy wallet, or session-key path is configured enough to request a bounded signature, prepare a redacted provider packet, and accept a validated hash-only signer-request rehearsal, but they do not store secrets, raw transaction bodies, or signed payloads.",
  ...
  },
  {
    ...
    items: [
      ...
      "Signer ops provider, policy hash, wallet scope, request count, provider packet action, adapter request hash, signer-request audit status, expiry, auto-sign, and user-presence values are local readiness metadata until real provider credentials and explicit live-gate approvals are configured.",
