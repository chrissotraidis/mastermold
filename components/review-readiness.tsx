...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "The trading cockpit now keeps the detailed usability, cutover, and operator-runbook receipts in a collapsed Readiness receipts and runbook drawer, so the operating view starts with the charted command surface while reviewers can still inspect JSON-linked evidence.",
