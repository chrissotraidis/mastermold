...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "Settings now mirrors the same next dependency blocker in the first-screen Web3 setup priority card and credential action console, so the operator sees the exact wallet/provider/review row to fix before opening deeper receipts.",
