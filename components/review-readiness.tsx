...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "Settings now includes a Web3 trading credentials runway that summarizes Helius/Solana, Jupiter, wallet, signer, emergency-stop, and accounting setup from the redacted account receipt, then links to Web3 Wiring without accepting or storing API keys.",
      "Settings now also includes a session-only Web3 credential action console that can test Helius/Solana, wallet scope, and Jupiter rehearsal routes without saving API keys, accepting private keys, returning transaction bytes, or unlocking live execution.",
      "Settings now shows a strict verifier runway that builds the operator-wallet and wallet-plus-Jupiter-order commands from the public wallet field, while marking sample-wallet or missing-Jupiter inputs as gated.",
      "A Node-only npm run verify:web3 gate now checks the running app's Web3 health receipts, malformed wallet rejection, private-field rejection, public dry-run wallet scope save, validate-only credential redaction, configured Helius/Solana provider-health proof, one-shot Jupiter rehearsal redaction, and live-execution/wallet-mutation locks for machines where Bun tests are unavailable.",
