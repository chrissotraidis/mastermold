...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "Autonomous daemon handoff now exposes an external-scheduler lease contract with endpoint, POST payload, renewal timing, max ticks/fills, provider budget, stop conditions, and paper-only live-boundary controls for a production runner to call the existing backend loop safely.",
