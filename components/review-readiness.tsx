...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "/api/health now exposes a compact web3_operator_runbook summary beside research handoff and live-usability health, so monitors can read the primary safe action, current input contract, safe command, and blocked live/signing/wallet authority without fetching the full runbook.",
