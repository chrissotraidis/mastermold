...
const disclosureSections = [
  ...
  },
  {
    ...
    items: [
      ...
      "Execution retry planning, preflight, transaction lifecycle tracking, signed-relay attempts, Jupiter Trigger create/history/reconcile drills, portfolio-mirror guard checks, and local portfolio-mirror patches record route, fee, quote age, quote timestamp, context slot, nonce, request id, retry-window, blocker metadata, payload hash, byte count, lifecycle stage, signature/status metadata, fill estimates, applied order ids, idempotency evidence, bounded fill notional, and synthetic signer proof locally. They do not store transaction bodies, sign with real keys, or accept private keys.",
