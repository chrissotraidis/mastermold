...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "A Node-only npm run status-canary:web3 command, /api/web3-canary-status, and the Trading Running app canary status panel now reconcile the running app's live canary, ignition, and local credential receipts with GET only, report whether a funded live trade was actually tested, fail on contradictory next-gate guidance, refuse unsafe secret-shaped flags, and keep signing, submission, wallet mutation, private-key storage, seed-phrase storage, and secret echo blocked.",
