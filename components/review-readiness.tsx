...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "The trading command board now shows that current input contract inside the real-money usability card, including target names and verifier command, so the main cockpit points at the exact safe setup field before live review.",
