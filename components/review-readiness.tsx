...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "/api/web3-live-ignition, Trading, /api/health, and npm run verify:web3 now expose one bot-facing real-money ignition go/no-go receipt that reconciles live scope, wallet scope, route/order proof, signer relay, autonomy gate, canary proof, and the safety boundary while can_autonomously_trade_real_money_now remains false until a funded canary is relayed, confirmed, reconciled, and mirrored.",
