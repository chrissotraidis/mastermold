...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "Settings now includes a live ops packet that consolidates production-supervisor freshness, emergency-stop target status, accounting/export readiness, safe ops commands, process-manager review, and manual live approval while external dispatch, live execution, transaction submission, and wallet mutation remain blocked.",
      ...
      "Settings now also includes a Web3 credential action console that can test Helius/Solana, read-only DEX scanner evidence, wallet scope, Jupiter rehearsal routes, emergency-stop/accounting target setup, and a localhost-only ignored-env credential install path without saving API keys to browser storage, accepting private keys, returning transaction bytes, dispatching webhooks, or unlocking live execution.",
