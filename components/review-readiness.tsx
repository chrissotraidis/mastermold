...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "A read-only Solana wallet holdings adapter can now query watched SPL token balances with getTokenAccountsByOwner when SOLANA_RPC_URL and a public wallet key are scoped, then feed those balances into local protection and dry-run route rehearsal without signatures, private keys, approvals, transfers, custody, or wallet mutation.",
