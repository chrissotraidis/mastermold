...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "The Web3 trading page now also renders a Web3 usability status receipt that separates usable copilot/paper surfaces from gated dry-run orders, supervised live review, and locked autonomous live trading without returning secrets or wallet authority.",
      ...
      "Execution readiness now separates ready, exhausted, and too-small dry-run caps, returning a safe cap repair action so operators can reset paper state or save larger local rehearsal caps without changing live-execution locks.",
