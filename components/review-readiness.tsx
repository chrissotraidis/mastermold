...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "Settings now also includes a Web3 credential action console that can test Helius/Solana, read-only DEX scanner evidence, wallet scope, Jupiter rehearsal routes, and a localhost-only ignored-env credential install path without saving API keys to browser storage, accepting private keys, returning transaction bytes, or unlocking live execution.",
