...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "/api/web3-dedicated-wallet-intake-contract now supports validate-only POST for proposed public wallet scope, returning redacted wallet preview, field-path validation, sample-wallet rejection, and cap blockers without saving state, signing, submitting, mutating wallets, or echoing secrets.",
