...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "Provider credential readiness now turns wallet scope, redacted provider credential scope, policy hash continuity, custody envelope state, signer request evidence, provider request packet readiness, user-presence requirements, and live-boundary locks into one launch-checklist receipt.",
      ...
      "Live wallet accounting readiness now turns wallet scope, RPC configuration, SPL account sync, pricing coverage, local portfolio application, settlement reconciliation, guarded mirror evidence, and wallet-mutation locks into one API-readable launch gate before live PnL can be trusted.",
      ...
      "Sample-mode route repair now exposes a paper-only route rehearsal receipt for local accountability repair, while real Jupiter quote requests, signer paths, and wallet mutation remain separately blocked.",
  ...
  },
  {
    ...
    items: [
      ...
      "Provider credential readiness is redacted review evidence only. It can prove that credential scope, policy hash, signer request, and provider packet metadata line up, but it cannot expose secrets, create custody, sign, submit, or authorize real-capital trading.",
      ...
      "Live wallet accounting readiness is a read-only evidence gate. It can prove wallet scope, RPC sync, pricing coverage, local portfolio mirroring, and settlement/mirror status, but it cannot authorize trades, custody assets, guarantee exchange-statement accuracy, or move funds.",
