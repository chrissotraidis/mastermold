...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "The Web3 trading command center now includes an actual live-trade test ledger that separates paper autonomy, read-only live DEX reads, Jupiter/order rehearsal, live flag arming, and funded-wallet trade proof so paper profit and rehearsals are not mistaken for real money movement.",
