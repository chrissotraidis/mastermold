...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "Signer ops compares external wallet prompts, Privy server-wallet, Turnkey policy-wallet, and session-key-vault paths, then exposes the active provider's hash-only signature request envelope plus redacted provider-adapter request hash, auto-sign, user-presence, payload-hash, expiry, cap, and live-gate readiness without returning raw or signed transaction bytes.",
  ...
  },
  {
    ...
    items: [
      ...
      "Signer ops results are provider readiness metadata. They can say whether a wallet prompt, Privy-style server wallet, Turnkey-style policy wallet, or session-key path is configured enough to request a bounded signature, and can expose a redacted provider-adapter request hash, but they do not store secrets, raw transaction bodies, or signed payloads.",
  ...
  },
  {
    ...
    items: [
      ...
      "Signer ops provider, policy hash, wallet scope, request count, adapter request hash, expiry, auto-sign, and user-presence values are local readiness metadata until real provider credentials and explicit live-gate approvals are configured.",
