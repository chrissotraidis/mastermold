...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "Settlement fill reconciliation can call Solana getTransaction for the latest audited confirmed signature and summarize token balance deltas, but ambiguous, missing, failed, complex, or over-cap fill evidence stays blocked.",
