...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "/api/web3-live-trade-canary, Trading, and Settings now explicitly state whether a real live trade has actually been tested, separate paper/read-only/Jupiter rehearsal from money movement, and show the post-signing proof chain for signed relay, chain confirmation, settlement reconciliation, and portfolio mirror accounting before anyone can claim real funds moved.",
