...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "A read-only npm run monitor:web3 command now refreshes live DEX discovery, auto-resolves GeckoTerminal OHLCV, records local candle proof into the trading cockpit, and keeps live execution, transaction submission, signing, wallet mutation, and secret echo blocked.",
