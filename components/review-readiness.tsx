...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "Trading now opens with a compact live trading command center driven by the first-canary drill receipt: drill status, hash, hard-fail count, proof count, live-dex drill link, leading failing lanes, next safe credential/blocker, and proof watcher command appear before the canary console, while detailed ignition and canary-readiness receipts sit in the review drawer.",
