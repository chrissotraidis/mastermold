...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "A Node-only npm run status-canary:web3 command now reconciles the running app's live canary, ignition, and local credential receipts with GET only, reports whether a funded live trade was actually tested, fails on contradictory next-gate guidance, refuses unsafe secret-shaped flags, and keeps signing, submission, wallet mutation, private-key storage, seed-phrase storage, and secret echo blocked.",
