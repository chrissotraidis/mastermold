...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "Live wallet accounting readiness now turns wallet scope, RPC configuration, aggregate Helius DAS asset-index proof, SPL account sync, pricing coverage, local portfolio application, settlement reconciliation, guarded mirror evidence, and wallet-mutation locks into one API-readable launch gate before live PnL can be trusted.",
