...
const disclosureSections = [
  {
    ...
    items: [
      ...
      "A Node-only npm run verify:web3 gate now snapshots and restores the saved public wallet/risk scope while checking the running app's Web3 health receipts, malformed wallet rejection, private-field rejection, public dry-run wallet scope save, validate-only credential redaction, configured Helius/Solana provider-health proof, operator request/cutover/runbook/supervised-runway packet boundaries, manual live-review packet boundaries, research handoff and research-answer implementation queue boundaries, deterministic DEX discovery receipt boundaries, one-shot Jupiter rehearsal redaction, and live-execution/wallet-mutation locks for machines where Bun tests are unavailable.",
