...
console.log(
  `Seeded reviewer@demo.local with ${summary.accounts} accounts, ${summary.assets} assets, ${summary.briefingCards} briefing cards, ${summary.alerts} alerts, and ${summary.integrations.join(", ")} integrations.`,
);
