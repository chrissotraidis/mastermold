...
secret echo blocked.
`/api/health` also exposes compact `web3_research_handoff` and `web3_live_usability`
summaries for monitors. The research health summary names the exact source/account/scenario
