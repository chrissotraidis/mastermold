...
export const demoDatabase: DemoDatabase = {
  ...
  briefingCards: [
    {
      ...
      date: eventDay,
      rank: 1,
      headline: "AI supply chain remains the highest-conviction briefing item",
    ...
    },
    {
      ...
      date: eventDay,
      rank: 2,
      headline: "Crypto basis is attractive, but only as display-only monitoring",
      why_now: "Funding observations stayed positive while ETF flow momentum cooled.",
      relevance_note: "BTC and on-chain_wallet exposure are seeded demo data; no capital is deployed.",
      bull_case: "Positive funding and controlled net delta would suit a monitored carry thesis.",
      bear_case: "Open interest is crowded and V0 has no live executor or transaction signing.",
      conviction: 5,
      horizon: "1 week",
      status: "actionable",
    ...
    },
    {
      ...
      date: eventDay,
      rank: 3,
      headline: "Nothing actionable today in small broker balances",
      why_now: "Robinhood and Coinbase stubs show no threshold breach outside tracked alerts.",
      relevance_note: "This is a designed empty state proving the app can say no.",
      bull_case: "Waiting preserves optionality and avoids over-trading demo signals.",
      bear_case: "Missed breakouts are possible if live integrations remain credential-gated.",
      conviction: 4,
      horizon: "Today",
  ...
  alerts: [
    { id: "alert_concentration", asset_id: "asset_btc", tier: "T1", z_score: 2.2, message: "BTC demo weight is above target band", rationale: "Top-position concentration plus elevated open interest warrants review.", created_at: "2026-05-30T00:30:00Z", acknowledged: false, useful_feedback: null, event_time: "2026-05-30T00:30:00Z", knowledge_time: "2026-05-30T00:31:00Z" },
    { id: "alert_account_change", asset_id: "asset_usdc_aave", tier: "T0", z_score: 3.1, message: "Sensitive account_change detected on onchain_wallet stub", rationale: "Seeded guardrail event confirms account changes are visible and inert.", created_at: "2026-05-29T18:45:00Z", acknowledged: false, useful_feedback: null, event_time: "2026-05-29T18:45:00Z", knowledge_time: "2026-05-29T18:46:00Z" },
    { id: "alert_hood", asset_id: "asset_hood", tier: "T2", z_score: 1.4, message: "Robinhood demo position moved but stayed below action threshold", rationale: "Useful as context only; no trade route exists.", created_at: "2026-05-29T20:10:00Z", acknowledged: true, useful_feedback: true, event_time: "2026-05-29T20:10:00Z", knowledge_time: "2026-05-29T20:11:00Z" },
  ],
  decisionJournalEntries: [
    ...
    { id: "journal_crypto", briefing_card_id: "brief_crypto_basis", thesis: "Observe basis carry only; do not execute in V0.", signals: ["funding rate", "open interest", "ETF flows"], conviction: 5, horizon: "1 week", falsification_condition: "Funding flips negative or margin ratio falls below guardrail.", logged_at: "2026-05-30T06:35:00Z", event_time: "2026-05-30T06:35:00Z", knowledge_time: "2026-05-30T06:35:30Z" },
  ],
  outcomeScores: [
    { id: "outcome_prev_ai", journal_entry_id: "journal_ai", resolved_at: "2026-05-30T07:00:00Z", pnl_note: "Demo replay only: thesis not resolved yet, scored for process completeness.", thesis_played_out: false, process_score: 8, outcome_score: 0, event_time: "2026-05-30T07:00:00Z", knowledge_time: "2026-05-30T07:01:00Z" },
    { id: "outcome_prev_crypto", journal_entry_id: "journal_crypto", resolved_at: "2026-05-30T07:05:00Z", pnl_note: "No real P&L; display-only monitoring preserved guardrails.", thesis_played_out: true, process_score: 7, outcome_score: 6, event_time: "2026-05-30T07:05:00Z", knowledge_time: "2026-05-30T07:06:00Z" },
  ],
  paperTradingRounds: [
