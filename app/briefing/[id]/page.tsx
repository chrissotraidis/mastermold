      ...
      <div className="mx-auto max-w-5xl space-y-6">
        ...
        <header className="space-y-5 border border-outline-variant/40 bg-surface-high/30 p-5 chamfer sm:p-6">
          ...
          <div className="grid gap-5 lg:grid-cols-[1fr_18rem] lg:items-end">
            ...
            <div className="grid grid-cols-[4.5rem_minmax(0,1fr)] gap-3 rounded-md border border-violet/30 bg-violet/10 p-3 lg:block lg:p-4">
              <div>
                <p className="text-xs font-medium uppercase tracking-[0.08em] text-violet lg:text-sm lg:normal-case lg:tracking-normal">Review score</p>
                <p className="mt-1 text-3xl font-semibold leading-none text-on-surface lg:mt-2 lg:text-4xl">{card.conviction}/10</p>
              </div>
              <div className="min-w-0">
                <p className="text-sm font-semibold leading-5 text-on-surface lg:mt-1">{briefingStrengthLabel(card.conviction)}</p>
                <p className="mt-1 line-clamp-2 text-sm leading-5 text-on-surface-variant lg:mt-2 lg:line-clamp-none lg:leading-6">{plainIdeaDetailText(card.relevance_note)}</p>
              </div>
            </div>
          </div>
        </header>
