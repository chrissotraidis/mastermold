...
export async function GET(request: Request): Promise<NextResponse<Web3DedicatedWalletPacket | { error: string }>> {
  ...
  return NextResponse.json(buildWeb3DedicatedWalletPacket(state));
}
