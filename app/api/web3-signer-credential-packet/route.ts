...
export async function GET(request: Request): Promise<NextResponse<Web3SignerCredentialPacket | { error: string }>> {
  ...
  return NextResponse.json(buildWeb3SignerCredentialPacket(state));
}
