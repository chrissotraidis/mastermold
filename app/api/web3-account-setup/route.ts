...
export async function GET(request: Request): Promise<NextResponse<Web3AccountSetupReceipt | { error: string }>> {
  ...
  return NextResponse.json(buildWeb3AccountSetupReceipt(state));
}
