...
export async function GET(request: Request): Promise<NextResponse<Web3JupiterOrderPacket | { error: string }>> {
  ...
  return NextResponse.json(buildWeb3JupiterOrderPacket(state));
}
